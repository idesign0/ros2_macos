...
// Dhruv's Note: Include the correct header for exceptions in Humble.
// Previously attempted to include non-existent 'nav2_util/exceptions.hpp' in Humble.
// Correct header for planning-related exceptions:
